        ...
        >
          <Row>
            <Col flex="550px" className="title">
              <h1>Dung lượng lưu trữ trên đám mây cá nhân của OneDrive</h1>
              <h2>
                Lưu các tệp và ảnh của bạn vào OneDrive và truy nhập chúng từ
                mọi thiết bị, ở mọi nơi.
              </h2>

              <Button type="primary" className="btn-auth" size="large">
                Đăng nhập
              </Button>
              <Button
                className="btn-auth "
                size="large"
                style={{ borderColor: "#0078d4", borderWidth: 2 }}
              >
                Đăng ký miễn phí
              </Button>
            </Col>
